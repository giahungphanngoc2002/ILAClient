...
function MyClasses() {
    ...
    console.log("setClasses",classes)
    ...
    const handleGoToTeachingMaterial = (idClass,idSubject) => {
        navigate(`/manage/teachingMaterial/${idClass}/${idSubject}`);
    };

    const handleGoToAttendanceTable = (idClass, idSubject, idSlot) => {
        navigate(`/manage/attendanceTable/${idClass}/${idSubject}/${idSlot}`);
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                            ...
                            <Button
                                variant="success"
                                onClick={() =>
                                    handleGoToAttendanceTable(
                                        selectedClass._id, 
                                        selectedClass.selectedSubject._id, 
                                        selectedClass.selectedSubject.slotId._id 
                                    )
                                }
                            >
                                Truy cập điểm danh
